        ...
        <div class="row">
            ...
            <div class="col s12 m4">
                <div class="card yellow darken-3">
                    <div class="card-content">
                        <span class="card-title white-text"><i class="material-icons md-36">description</i> Jumlah Surat Sudah Didisposisi</span>
            ...
            <a href="?page=tst">
                <div class="col s12 m4">
                    <div class="card deep brown">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">drafts</i> Jumlah Surat Keluar/Surat Tugas</span>
