                                                ...
                                                if($file != ""){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2500000){
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,nosu_lengkap,isi,kode,tgl_surat,
                                                                tgl_catat,file,keterangan,id_user)
                                                                VALUES('$no_agenda','$tujuan','$no_surat', '$nosu_lengkap','$isi','$nkode','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user')");
                                                    ...
                                                    $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,tujuan,no_surat,nosu_lengkap,isi,kode,tgl_surat,
                                                        tgl_catat,file,keterangan,id_user)
                                                        VALUES('$no_agenda','$tujuan','$no_surat','$nosu_lengkap','$isi','$nkode','$tgl_surat',NOW(),'','$keterangan','$id_user')");
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsk&act=add" class="judul"><i class="material-icons">drafts</i> Tambah Data Surat Keluar (Silahkan Ubah Nomor Agenda dan Nomor Surat)</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            echo '<input id="no_agenda" type="number" class="validate" name="no_agenda" value="';
                                $sql = mysqli_query($config, "SELECT no_agenda FROM tbl_surat_keluar order by no_agenda ASC");
                                $no_agenda = "1";
                        ...
                        <div class="input-field col s6">
                            ...
                            <?php
                                ...
                                echo '<input id="no_surat" type="text" class="validate" name="no_surat" value="';
                                $sql = mysqli_query($config, "SELECT no_surat FROM tbl_surat_keluar order by no_surat ASC");
                                $no_surat = "001";
                                if (mysqli_num_rows($sql) == 0){
                                    echo $no_surat;
                                }
                                ...
                                $result = mysqli_num_rows($sql);
                                $counter = 0;
                                while(list($no_surat) = mysqli_fetch_array($sql)){
                                    if (++$counter == $result) {
                                        $no_surat++;
                                        $urutan=$no_surat++;
                                        $no_surat = sprintf("%03s", $urutan);
                                        echo $no_surat;
                                    }
                                }
                                echo '" required>';
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">featured_play_list</i><br>
                              <div class="input-field col s11 right"> 
                                <select name="keterangan" id="keterangan" type="text" class="browser-default validate" required>
                                      <option value="Surat Eksternal"> <font size="1.0rem">Surat Eksternal</option>
                                      <option value="Surat Internal">Surat Internal</option>
                                      <option value="Surat PPK/PBJ">Surat PPK/PBJ</option>
