<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT id_surat, no_agenda, no_surtug,jenis_surat,tgl_surtug,kode,kode_spd,no_lamp_spd,nosu_lengkap,tujuan_tgs,tgl_mulai,tgl_selesai, file, beban_ang,id_user FROM tbl_surat_tugas WHERE id_surat='$id_surat'");
