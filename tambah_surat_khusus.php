                                          ...
                                          if(!preg_match("/^[0-9.-]*$/", $tgl_mulai)){
                                            ...
                                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $beban_ang)){
                                               ...
                                               if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $jenis_surat)){
                                                ...
                                                $cek = mysqli_query($config, "SELECT * FROM tbl_surat_khusus WHERE no_surtug='$no_surtug'");
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsk&act=add" class="judul"><i class="material-icons">mail</i> Tambah Data Surat Khusus</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                ...
                <form class="col s12" method="POST" action="?page=tsk&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            ?>
                            <label for="no_surtug">Nomor Surat Khusus</label>
                        </div>
                        ...
                        <label for="kode_spd">Kode SPD Lampiran Surat Khusus</label>
                        </div>  
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="tgl_surtug" type="text" name="tgl_surtug" class="datepicker" required>
                                ...
                                ?>
                            <label for="tgl_surtug">Tanggal Surat Khusus</label>
                        </div>
