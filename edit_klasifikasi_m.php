        ...
        if(isset($_REQUEST['submit'])){
                ...
                if($_REQUEST['kode'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['uraian'] == ""){
                    ...
                    echo '<script language="javascript">
                            window.location.href="./admin.php?page=refm&act=edit&id_klasifikasi='.$id_klasifikasi.'";
                          </script>';
                } else {
                ...
                if(!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $kode)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $nama)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,()\/\r\n -]*$/", $uraian)){
                            ...
                            $query = mysqli_query($config, "UPDATE tbl_klasifikasi_m SET kode='$kode', nama='$nama', uraian='$uraian', id_user='$id_user' WHERE id_klasifikasi='$id_klasifikasi'");
            ...
            if(mysqli_num_rows($query) > 0){
                ...
                if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
                    ...
                    <div class="row jarak-form">
                        ...
                        <!-- Form START -->
                        <form class="col s12" method="post" action="?page=refm&act=edit">
