            ...
            $pg = @$_GET['pg'];
                if(empty($pg)){
                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal' WHERE file <>'' ORDER By id_surat DESC LIMIT 10");
                        ...
                        if($pg > 1){
                            $prev = $pg - 1;
                            echo '<li><a href="?page=gsm&pg=1"><i class="material-icons md-36">first_page</i></a></li>
                                  <li><a href="?page=gsm&pg='.$prev.'"><i class="material-icons md-36">chevron_left</i></a></li>';
                        } else {
                        ...
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=gsm&pg='.$next.'"><i class="material-icons md-36">chevron_right</i></a></li>
                                  <li><a href="?page=gsm&pg='.$cpg.'"><i class="material-icons md-36">last_page</i></a></li>';
                        } else {
