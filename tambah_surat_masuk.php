    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['asal_surat'] == "" || $_REQUEST['isi'] == ""
                ...
                $jam_upload_srt = $_REQUEST['jam_upload_srt'];
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 5300000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,kode,indeks,tgl_surat,
                                                                    tgl_diterima,file,keterangan,id_user,jam_upload_srt)
                                                                        VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nkode','$indeks','$tgl_surat',NOW(),'$nfile','$keterangan','$id_user','$jam_upload_srt')");
                                                                ...
                                                                if($query == true){
                                                                    ...
                                                                    $nope = '08158750328';
                                                                    $no_wa = trim($nope);
                                                                    //no WA bisniss 'target' => '085171153301'
                                                                    //no Pak Suswandi 'target' => '08158750328'
                                                                    $pesan = 'Yth Kepala BPS Kabupaten Cilacap *Suswandi MSE, MA* ' . $enter
                                                                            . $enter
                                                                            . 'Ada surat masuk : ' .$enter
                                                                            . 'Dengan nomor agenda: *' .$no_agenda . '* ' . $enter
                                                                            . 'Perihal: *' . $isi . '* ' . $enter
                                                                            . $enter
                                                                            . 'Silahkan cek pada aplikasi di https://s.bps.go.id/sikemas ' . $enter
                                                                            . 'Mohon lakukan disposisi jika ingin mendelegasikan ' . $enter
                                                                            . $enter
                                                                            . 'Terima kasih.';
                                                            ...
                                                            $_SESSION['errFormat'] = 'Format file yang diperbolehkan hanya *.JPG, *.PNG, *.DOC, *.DOCX, *.PDF, *.RAR, ATAU *.ZIP!';
                                                            echo '<script language="javascript">window.history.back();</script>';
                                                        }
                                                    } else {

                                                        //jika form file kosong akan mengeksekusi script dibawah ini
                                                        $query = mysqli_query($config, "INSERT INTO tbl_surat_masuk(no_agenda,no_surat,asal_surat,isi,kode,indeks,tgl_surat, tgl_diterima,file,keterangan,id_user,jam_upload_srt)
                                                            VALUES('$no_agenda','$no_surat','$asal_surat','$isi','$nkode','$indeks','$tgl_surat',NOW(),'','$keterangan','$id_user','$jam_upload_srt')");
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            echo '<input id="no_agenda" type="number" class="validate" name="no_agenda" value="';
                                $sql = mysqli_query($config, "SELECT no_agenda FROM tbl_surat_masuk order by no_agenda ASC");
                                $no_agenda = "1";
                        ...
                        <div class="input-field col s6">
                            ...
                            <div class="input-field col s11 right">   
                                <select name="kode" id="kode" type="text" class="browser-default validate" required>
                                     ...
                                     <?php 
                                     $query=mysqli_query($config, "select * from tbl_klasifikasi_m order by kode asc"); 
                                     $result = mysqli_query($config, "select * from tbl_klasifikasi_m order by kode asc");  
                        ...
                        <div class="input-field col s6">
                            ...
                            <textarea id="isi" type="text" class="materialize-textarea validate" name="isi" required></textarea>
                                <?php
                            ...
                            <div class="file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload file/scan gambar surat masuk">
                                        ...
                                        ?>
                                    <small class="red-text">*Format file yang diperbolehkan *.JPG, *.PNG, *.DOC, *.DOCX, *.PDF,*.RAR, *.ZIP dan ukuran maksimal file 4 MB!</small>
                                </div>
                            </div>
                        </div>
                    </div>
