    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                ...
                $query = mysqli_query($config, "SELECT tbl_surat_khusus.id_suratkh, tbl_surat_khusus.no_agenda, tbl_surat_khusus.no_surtug, tbl_surat_khusus.jenis_surat, tbl_surat_khusus.tgl_surtug, tbl_surat_khusus.kode, tbl_surat_khusus.kode_spd, tbl_surat_khusus.no_lamp_spd, tbl_surat_khusus.nosu_lengkap, tbl_surat_khusus.nolamp_lkp, tbl_surat_khusus.tujuan_tgs, tbl_surat_khusus.tgl_mulai, tbl_surat_khusus.tgl_selesai, tbl_surat_khusus.file, tbl_surat_khusus.beban_ang, tbl_surat_khusus.id_user from tbl_surat_khusus WHERE tbl_surat_khusus.tgl_surtug BETWEEN '$dari_tanggal' AND '$sampai_tanggal' order by tbl_surat_khusus.no_agenda, tbl_surat_khusus.tgl_surtug ASC");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Agenda Surat Khusus<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="row agenda">
                        <div class="disp hidd">';
                            ...
                            <h5 class="hid">AGENDA SURAT Khusus</h5>
                        <div class="col s10">
                            <p class="warna agenda">Agenda Surat Khusus dari tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                        </div>
                        <div class="col s2">
                        ...
                        <table class="bordered" id="tbl" width="120%">
                            <thead class="blue lighten-4">
                                <tr>
                                    ...
                                    <th width="15%">Tanggal Surat Khusus/<br/>Surat Keluar</th>
                                    <th width="12%">Jenis Surat</th>
                                    <th width="15%">Nomor Lampiran SPD</th>
                                    <th width="38%">Tujuan Surat Keluar<br/> Perihal Surat Khusus</th>
