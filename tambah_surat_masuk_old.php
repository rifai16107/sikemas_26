                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if($query == true){
                                                            ...
                                                            //API notifikasi whatsApp
                                                                ...
                                                                'target' => '081328412970',
                                                                'message' => 'Yth Kepala BPS Kab. Cilacap, *Bpk Isnaini, SST, MM*, Ada surat masuk, silahkan cek pada tautan: https://s.bps.go.id/surat_3301 , mohon lakukan disposisi jika ingin mendelegasikan',
                                                                'delay' => '1',
                                                                'schedule' => '0'),
