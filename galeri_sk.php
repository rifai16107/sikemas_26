            ...
            $pg = @$_GET['pg'];
                ...
                echo '
                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        if($pg > 1){
                            $prev = $pg - 1;
                            echo '<li><a href="?page=gsk&pg=1"><i class="material-icons md-36">first_page</i></a></li>
                                  <li><a href="?page=gsk&pg='.$prev.'"><i class="material-icons md-36">chevron_left</i></a></li>';
                        } else {
                        ...
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=gsk&pg='.$next.'"><i class="material-icons md-36">chevron_right</i></a></li>
                                  <li><a href="?page=gsk&pg='.$cpg.'"><i class="material-icons md-36">last_page</i></a></li>';
                        } else {
