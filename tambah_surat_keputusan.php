    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
                                ...
                                if(!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)){
                                    ...
                                    if(!preg_match("/^[0-9.-]*$/", $tgl_sk)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                            ...
                                            $cek = mysqli_query($config, "SELECT * FROM tbl_surat_keputusan WHERE no_sk='$no_sk'");
                                                ...
                                                if($file != ""){
                                                    ...
                                                    if(in_array($eks, $ekstensi) == true){
                                                        if($ukuran < 2500000){
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_keputusan(no_agenda,no_sk,nosk_lengkap,isi,kode,tgl_sk,tgl_catat,file,keterangan,id_user)
                                                                VALUES('$no_agenda','$no_sk', '$nosk_lengkap','$isi','$nkode','$tgl_sk',NOW(),'$nfile','$keterangan','$id_user')");
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tskep&act=add" class="judul"><i class="material-icons">drafts</i> Tambah Data Surat Keputusan</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=tskep&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <?php
                            echo '<input id="no_agenda" type="number" class="validate" name="no_agenda" readonly value="';
                                $sql = mysqli_query($config, "SELECT no_agenda FROM tbl_surat_keputusan order by no_agenda ASC");
                                $no_agenda = "1";
                        ...
                        <div class="input-field col s6">
                            ...
                            <?php
                                ...
                                echo '<input id="no_sk" type="text" class="validate" name="no_sk" readonly value="';
                                $sql = mysqli_query($config, "SELECT no_sk FROM tbl_surat_keputusan order by no_sk ASC");
                                $no_sk = "001";
                                if (mysqli_num_rows($sql) == 0){
                                    echo $no_sk;
                                }
                                ...
                                $result = mysqli_num_rows($sql);
                                $counter = 0;
                                while(list($no_sk) = mysqli_fetch_array($sql)){
                                    if (++$counter == $result) {
                                        $no_sk++;
                                        $urutan=$no_sk++;
                                        $no_sk = sprintf("%03s", $urutan);
                                        echo $no_sk;
                                    }
                                }
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">bookmark</i><br><br>
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="tgl_sk" type="text" name="tgl_sk" class="datepicker" required>
                                <?php
                                    if(isset($_SESSION['tgl_skk'])){
