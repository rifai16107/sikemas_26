        ...
        <div class="z-depth-1">
            <nav class="secondary-nav">
                <div class="nav-wrapper blue darken-1">
                    <div class="col m12">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="?page=surtu" class="judul"><i class="material-icons">mail</i> Surat Tugas Saya</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
...
<?php
            ...
            $query = mysqli_query($config, "SELECT tbl_surat_masuk.id_surat, tbl_surat_masuk.no_agenda, tbl_surat_masuk.no_surat, tbl_surat_masuk.asal_surat, tbl_surat_masuk.isi,tbl_surat_masuk.kode, tbl_surat_masuk.indeks, tbl_surat_masuk.tgl_surat, tbl_surat_masuk.tgl_diterima,tbl_surat_masuk.file, tbl_surat_masuk.keterangan, tbl_surat_masuk.id_user, tbl_disposisi.tujuan, tbl_disposisi.id_disposisi, tbl_disposisi.isi_disposisi, tbl_disposisi.batas_waktu FROM tbl_surat_masuk LEFT OUTER JOIN tbl_disposisi ON tbl_surat_masuk.id_surat=tbl_disposisi.id_surat AND tbl_disposisi.id_disposisi= IS NULL ORDER BY tbl_disposisi.id_disposisi DESC");
