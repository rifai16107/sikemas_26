        ...
        if(isset($_REQUEST['act'])){
            ...
            switch ($act) {
                case 'add':
                    ...
                    break;
                case 'sisip':
                    include "sisip_surat_keluar.php";
                    break;
                case 'edit':
                                ...
                                <div class="nav-wrapper blue darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            ...
                                            <li class="waves-effect waves-light">
                                                <a href="?page=tsk&act=sisip"><i class="material-icons md-24">add_circle</i> Sisip Nomor Surat Keluar</a>
                                            </li>
                        ...
                        <table id="dataTables1" class="table table-striped table-bordered table-hover">
                            <thead class="thead-dark" id="head">
                                <tr>
                                    ...
                                    <th width="31%">Perihal Surat/Isi Ringkas<br/> File</th>
                                    <th width="24%">Tujuan</th>
                                    <th width="10%">Tgl Surat</th>
                                    <th width="26%">Tindakan <span class="right tooltipped" data-position="left"</th>
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar ORDER BY no_surat DESC");
                            if(mysqli_num_rows($query) > 0){
                                $no = 1;
                                while($row = mysqli_fetch_array($query)){
                                  echo '
                                  <tr>
                                    <td>'.$row['no_agenda'].'</td><td>'.$row['nosu_lengkap'].'</td>
