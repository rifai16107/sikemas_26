        ...
        if(isset($_REQUEST['submit'])){
                ...
                if($_REQUEST['kode'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['uraian'] == ""){
                    ...
                    echo '<script language="javascript">
                            window.location.href="./admin.php?page=refspd&act=edit&id_klasifikasi='.$id_klasifikasi.'";
                          </script>';
                } else {
                ...
                if(!preg_match("/^[a-zA-Z0-9. ]*$/", $kode)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $nama)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,()\/\r\n -]*$/", $uraian)){
                            ...
                            $query = mysqli_query($config, "UPDATE tbl_klasifikasi_spd SET kode='$kode', nama='$nama', uraian='$uraian', id_user='$id_user' WHERE id_klasifikasi='$id_klasifikasi'");

                            if($query != false){
                                $_SESSION['succEdit'] = 'SUKSES! Data berhasil diupdate';
                                header("Location: ./admin.php?page=refspd");
                                die();
                            } else {
            ...
            $query = mysqli_query($config, "SELECT * FROM tbl_klasifikasi_spd WHERE id_klasifikasi='$id_klasifikasi'");
            if(mysqli_num_rows($query) > 0){
                ...
                if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
                    echo '<script language="javascript">
                            ...
                            window.location.href="./admin.php?page=refspd";
                          </script>';
                } else {?>
                        ...
                        <div class="col s12">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <ul class="left">
                                        <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit Klasifikasi SPD</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                    ...
                    <div class="row jarak-form">
                        ...
                        <!-- Form START -->
                        <form class="col s12" method="post" action="?page=refspd&act=edit">
                            ...
                            <div class="row">
                                ...
                                <div class="col 6">
                                    <a href="?page=refspd" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                                </div>
                            </div>
