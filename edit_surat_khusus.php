<?php
    ...
    if(empty($_SESSION['admin'])){
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 5000000){
                                                        ...
                                                        $query = mysqli_query($config, "SELECT file FROM tbl_surat_khusus WHERE id_suratkh='$id_suratkh'");
        ...
        $query = mysqli_query($config, "SELECT id_suratkh, no_agenda, no_surtug,jenis_surat,tgl_surtug,kode,kode_spd,no_lamp_spd,nosu_lengkap,tujuan_tgs,tgl_mulai,tgl_selesai, file, beban_ang,id_user FROM tbl_surat_khusus WHERE id_suratkh='$id_suratkh'");
        list($id_suratkh, $no_agenda, $no_surtug, $jenis_surat, $tgl_surtug, $kode, $kode_spd, $no_lamp_spd, $nosu_lengkap, $tujuan_tgs, $tgl_mulai, $tgl_selesai, $file, $beban_ang, $id_user) = mysqli_fetch_array($query);
                ...
                <form class="col s12" method="POST" action="?page=tsk&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input type="hidden" name="id_suratkh" value="<?php echo $id_suratkh ;?>">
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" value="<?php echo $file ;?>" placeholder="Upload file/scan gambar surat khusus">
                                        <?php
