                                          ...
                                          if(!preg_match("/^[0-9.-]*$/", $tgl_mulai)){
                                            ...
                                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $beban_ang)){
                                               ...
                                               if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $jenis_surat)){
                                                ...
                                                $cekspd = mysqli_query($config, "SELECT * FROM tbl_surat_tugas WHERE no_lamp_spd='$no_lamp_spd'");
                                                ...
                                                $cek = mysqli_query($config, "SELECT * FROM tbl_surat_tugas WHERE no_surtug='$no_surtug'");
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            if($ukuran < 5000000){
                                                                ...
                                                                $query = mysqli_query($config, "INSERT INTO tbl_surat_tugas(no_agenda,no_surtug,jenis_surat,tgl_surtug,kode,kode_spd,no_lamp_spd,nosu_lengkap,nolamp_lkp,tujuan_tgs,tgl_mulai, tgl_selesai,file,beban_ang,id_user)
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tst&act=add" class="judul"><i class="material-icons">mail</i> Tambah Data Surat Keluar/Surat Tugas</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            echo '<input id="no_agenda" type="number" class="validate" name="no_agenda" value="';
                                $sql = mysqli_query($config, "SELECT no_agenda FROM tbl_surat_tugas order by no_agenda ASC");
                                $no_agenda = "1";
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">featured_play_list</i><br>
                                 ...
                                 <select name="jenis_surat" id="jenis_surat" type="text" class="browser-default validate" required>
                        ...
                        <div class="input-field col s6">
                                <i class="material-icons prefix md-prefix">description</i><br>
                                    ...
                                    <?php
                                        ...
                                        $sql = mysqli_query($config, "SELECT no_lamp_spd FROM tbl_surat_tugas where no_lamp_spd <> '-' order by no_lamp_spd ASC");
                                        $no_lamp_spd = "001";
                                        if (mysqli_num_rows($sql) == 0){
                                            echo $no_lamp_spd;
                                        }
