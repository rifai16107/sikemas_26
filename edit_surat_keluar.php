        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['no_agenda'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['tujuan'] == "" || $_REQUEST['isi'] == ""
                ...
                $id_user = $_SESSION['id_user'];
                 ...
                 if($keterangan=="Surat Eksternal") {
                    echo $nosu_lengkap="B-".$no_surat."/3301/".$nkode."/".substr($tgl_surat,5,2)."/".substr($tgl_surat,0,4);
                    echo $keterangan; 
                } else if ($keterangan=="Surat Internal") {
                    echo $nosu_lengkap=$no_surat."/3301/".$nkode."/".substr($tgl_surat,5,2)."/".substr($tgl_surat,0,4);
                    echo $keterangan;
                } else {
                    echo $nosu_lengkap=$no_surat."/3301/".substr($tgl_surat,5,2)."/".substr($tgl_surat,0,4);
                    echo $keterangan; 
                }
                                    ...
                                    if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 2500000){
                                                        ...
                                                        if(!empty($file)){
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_surat_keluar SET no_agenda='$no_agenda',tujuan='$tujuan',no_surat='$no_surat',nosu_lengkap='$nosu_lengkap',isi='$isi',kode='$nkode',tgl_surat='$tgl_surat',file='$nfile',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
                                                ...
                                                $query = mysqli_query($config, "UPDATE tbl_surat_keluar SET no_agenda='$no_agenda',tujuan='$tujuan',no_surat='$no_surat',nosu_lengkap='$nosu_lengkap',isi='$isi',kode='$nkode',tgl_surat='$tgl_surat',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
            ...
            $query = mysqli_query($config, "SELECT id_surat, no_agenda, tujuan, no_surat, nosu_lengkap, isi, kode, tgl_surat, file, keterangan, id_user FROM tbl_surat_keluar WHERE id_surat='$id_surat'");
            list($id_surat, $no_agenda, $tujuan, $no_surat, $nosu_lengkap, $isi, $kode, $tgl_surat, $file, $keterangan, $id_user) = mysqli_fetch_array($query);
                    ...
                    <form class="col s12" method="POST" action="?page=tsk&act=edit" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="no_surat" type="text" class="validate" readonly name="no_surat" value="<?php echo $no_surat ;?>" required>
                                    <?php
                            ...
                            <div class="input-field col s6">
                               ...
                               <div class="input-field col s11 right">
                                 <select class="browser-default validate" id="keterangan" name="keterangan" required>
                                      <option value="Surat Eksternal" <?php if($keterangan == 'Surat Eksternal'){ echo 'selected'; } ?>>Surat Eksternal</option>
                                      <option value="Surat Internal" <?php if($keterangan == 'Surat Internal'){ echo 'selected'; } ?>>Surat Internal</option>
                                      <option value="Surat PPK/PBJ" <?php if($keterangan == 'Surat PPK/PBJ'){ echo 'selected'; } ?>>Surat PPK/PBJ</option>
                                      <option value="Surat Keputusan (SK)" <?php if($keterangan == 'Surat Keputusan (SK)'){ echo 'selected'; } ?>>Surat Keputusan (SK)</option>                                       
                                 </select><br> 
                               </div> 
