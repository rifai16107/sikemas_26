<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['tujuan'] == "" || $_REQUEST['nope'] == "" || $_REQUEST['isi_disposisi'] == "" || $_REQUEST['sifat'] == "" || $_REQUEST['batas_waktu'] == ""
                || $_REQUEST['catatan'] == ""){
                ...
                if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $tujuan)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n - ! ?]*$/", $isi_disposisi)){
                        $_SESSION['isi_disposisi'] = 'Form Isi Disposisi hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan(&), underscore(_), kurung(), tanda tanya dan tanda seru (?,!), persen(%) dan atau(@)';
                        echo '<script language="javascript">window.history.back();</script>';
                    } else {
                        ...
                        if(!preg_match("/^[0-9 -]*$/", $batas_waktu)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()%@\/ -]*$/", $catatan)){
                                ...
                                if(!preg_match("/^[a-zA-Z0 ]*$/", $sifat)){
                                    ...
                                    $query = mysqli_query($config, "UPDATE tbl_disposisi SET tujuan='$tujuan', nope='$nope', isi_disposisi='$isi_disposisi', sifat='$sifat', batas_waktu='$batas_waktu', catatan='$catatan', id_surat='$id_surat', id_user='$id_user' WHERE id_disposisi='$id_disposisi'");
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                ...
                                <div class="input-field col s11 right">  
                                   <select name="tujuan" id="tujuan" type="text" class="browser-default validate" onchange='changeValue(this.value)' readonly>
                                ...
                                <input id="nope" type="text" class="validate" name="nope" value="<?php echo $row['nope'];?>" readonly>   
