                                            ...
                                            <div class="nav-wrapper blue darken-1">
                                                <div class="col m12">
                                                    <ul class="left">
                                                        ...
                                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=cek_dispo"><i class="material-icons">arrow_back</i> List Surat Belum Didisposisi</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </nav>
                                ...
                                <div class="card blue lighten-5">
                                    <div class="card-content">
                                        <div class="row">
                                             ...
                                             <div class="col s4"    
                                                <p><p class="description">Asal Surat :</p>'.$row['asal_surat'].'</p>
                                             </div>
                                             <div class="col s3"    
                                                <p><p class="description">Tanggal Surat :</p>'.$row['tgl_surat'].'</p>
                                             </div>
                                        </div>
                                            ...
                                            $no++;
                                             echo '
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'&id_disposisi='.$row['id_disposisi'].'" target="_print" title="PRINT">
                                                        <i class="material-icons">print</i> </a> 
                                                        <a class="btn small blue waves-effect waves-light" href="?page=tsm&act=disp&id_surat='.$id_surat.'&sub=edit&id_disposisi='.$row['id_disposisi'].'" title="EDIT">
                                                            <i class="material-icons">edit</i></a> 
                                                        <a class="btn small deep-orange waves-effect waves-light" href="?page=tsm&act=disp&id_surat='.$id_surat.'&sub=del&id_disposisi='.$row['id_disposisi'].'" title="DEL"><i class="material-icons">delete</i></a>
                                                    </td>
                                            </tr>';
                                            }
                                        } else {
