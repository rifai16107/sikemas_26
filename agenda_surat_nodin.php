    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                header("Location: ./admin.php?page=asn");
                die();
            } else {

                $query = mysqli_query($config, "SELECT tbl_surat_nodin.id_nodin, tbl_surat_nodin.no_agenda, tbl_surat_nodin.no_surtug, tbl_surat_nodin.jenis_surat, tbl_surat_nodin.tgl_surtug, tbl_surat_nodin.kode, tbl_surat_nodin.kode_spd, tbl_surat_nodin.no_lamp_spd, tbl_surat_nodin.nosu_lengkap, tbl_surat_nodin.nolamp_lkp, tbl_surat_nodin.tujuan_tgs, tbl_surat_nodin.tgl_mulai, tbl_surat_nodin.tgl_selesai, tbl_surat_nodin.file, tbl_surat_nodin.beban_ang, tbl_surat_nodin.id_user from tbl_surat_nodin WHERE tbl_surat_nodin.tgl_surtug BETWEEN '$dari_tanggal' AND '$sampai_tanggal' order by tbl_surat_nodin.no_agenda, tbl_surat_nodin.tgl_surtug ASC");
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=asn" class="judul"><i class="material-icons">print</i> Cetak Agenda Nota Dinas<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                        ...
                        <table class="bordered" id="tbl" width="120%">
                            <thead class="blue lighten-4">
                                <tr>
                                    ...
                                    <th width="24%">Nomor Nota Dinas</th>
                                    <th width="15%">Tanggal Surat Dinas/<br/>Surat Keluar</th>
                                    <th width="12%">Jenis Surat</th>
                                    <th width="15%">Nomor dan<br/>Kode MAK Kegiatan</th>
