        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['submit'])){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9. ]*$/", $kode)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $nama)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()\/\r\n -]*$/", $uraian)){
                                ...
                                $cek = mysqli_query($config, "SELECT * FROM tbl_klasifikasi_spd WHERE kode='$kode'");
                                ...
                                if($result > 0){
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO tbl_klasifikasi_spd (kode,nama,uraian,id_user) VALUES('$kode','$nama','$uraian','$id_user')");
                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="?page=refspd&act=add" class="judul"><i class="material-icons">bookmark</i> Tambah Klasifikasi SPD</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="row jarak-form">
                    ...
                    <!-- Form START -->
                    <form class="col s12" method="post" action="?page=refspd&act=add">
